...
public class Bicycle extends Vehicle {
	...
	private final int CYCLE_COST = 20;
	private final int PASSENGER_COST = 20;
	private final int PARKING_SPACE = 1; // in terms of bicycle
	...
	public Bicycle() {
		...
		/* Create a bicycle with all the requirements */
		setVehicleSize(PARKING_SPACE);
		setVehicalCost(CYCLE_COST);
